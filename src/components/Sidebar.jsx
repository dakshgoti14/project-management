...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    return (
        <>
            ...
            {isSidebarOpen && (
                <div
                    className="fixed inset-0 sidebar-backdrop z-20 sm:hidden"
                    onClick={() => setIsSidebarOpen(false)}
                />
            )}

            <div ref={sidebarRef} className={`z-30 bg-white dark:bg-zinc-900 min-w-68 flex flex-col h-screen border-r border-gray-200 dark:border-zinc-800 fixed sm:static sidebar-transition ${isSidebarOpen ? 'left-0' : '-left-full'} `}>
                <WorkspaceDropdown />
